...
const MeetingTypeList = () => {
  ...
  const meetingLink = `http://${process.env.NEXT_PUBLIC_BASE_URL}/meeting/${callDetails?.id}`
    ...
    <section className="grid grid-cols-1 gap-5 
     md:grid-cols-2 xl:grid-cols-4">
      ...
      >
        ...
        className="broder-none bg-dark-3 focus-visible:ring-0 focus-visible:ring-offset-0"
